...
public interface EnCzJoinDao {
     ...
     */
    @Query("SELECT * FROM czWords INNER JOIN enWords_czWords_join ON czWords.id = enWords_czWords_join.czWordId \n" +
            "WHERE enWords_czWords_join.enWordId = :enWordId")
     ...
     */
    @Query("SELECT * FROM enWords INNER JOIN enWords_czWords_join ON enWords.id = enWords_czWords_join.enWordId \n" +
            "WHERE enWords_czWords_join.czWordId = :czWordId")
