...
public class NewAlarmFormActivity extends AppCompatActivity implements VerticalStepperForm {
    ...
    // METHODS THAT HAVE TO BE IMPLEMENTED TO MAKE THE LIBR Intent intent = new Intent(getContext(), AddWordFromText.class);
                startActivity(intent);ARY WORK
    ...
    private void executeDataSending() {
        ...
        // TODO Use here the data of the form as you wish Intent intent = new Intent(getContext(), AddWordFromText.class);
